...
const images = {
    defender1: 'megaman-test.png',
    defender2: 'defender2.png',
    enemy1: 'Jeff-Bezos.png',
    enemy2: 'elon-test.png',
    coin: 'coin_static.png'
};
...
loadImages()
    .then((loadedImages) => {
        ...
        // Use the loaded images in your application
        const loadedImageObjects = {};
        loadedImages.forEach(({ key, img }) => {
            loadedImageObjects[key] = img;
        });

        // Now you can use loadedImageObjects to access your images
        const defender1 = loadedImageObjects.defender1;
        const defender2 = loadedImageObjects.defender2;
        const enemy1 = loadedImageObjects.enemy1;
        const enemy2 = loadedImageObjects.enemy2;
        const coin = loadedImageObjects.coin;
